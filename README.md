...
- `adapters/lampa-adapter/` — serves Lampa plugin JS and `/streams` endpoint that proxies to core.
...
6. Lampa plugin URL (for script tag): http://localhost:7011/plugin.js
